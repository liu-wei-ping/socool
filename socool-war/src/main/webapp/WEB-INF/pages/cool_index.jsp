...
<title>SO COOL | MUSIC</title>
<link rel="icon" sizes="any" mask  href="${pageContext.request.contextPath}/images/icons/logo.png">
<!-- main JS libs -->
<script src="${pageContext.request.contextPath}/js/libs/jquery-1.11.0.min.js"></script>
...
<!-- Style CSS -->
<link href="${pageContext.request.contextPath}/css/bootstrap.css" media="screen" rel="stylesheet">
<link href="${pageContext.request.contextPath}/css/style.css" media="screen" rel="stylesheet">

<!-- General Scripts Lil Wayne 右边框-->
<script src="${pageContext.request.contextPath}/js/general.js"></script>

<!-- CarouFredSel  -->
<script src="${pageContext.request.contextPath}/js/jquery.carouFredSel-6.2.1-packed.js"></script>
<script src="${pageContext.request.contextPath}/js/jquery.touchSwipe.min.js"></script> <!-- 没用 -->
...
<!-- Audio Player -->
<link href="${pageContext.request.contextPath}/css/jplayer.css" rel="stylesheet">
<script src="${pageContext.request.contextPath}/js/jplayer/jquery.jplayer.min.js"></script>
<script src="${pageContext.request.contextPath}/js/jplayer/jplayer.playlist.min.js"></script>
<script src="${pageContext.request.contextPath}/js/jplayer/jquery.transform2d.js"></script>
<script src="${pageContext.request.contextPath}/js/jplayer/jquery.grab.js"></script>
<script src="${pageContext.request.contextPath}/js/jplayer/mod.csstransforms.min.js"></script>
<script src="${pageContext.request.contextPath}/js/jplayer/circle.player.js"></script>

<!-- Graph Builder -->
<!-- <script src="https://www.google.com/jsapi"></script> -->

<!--[if lt IE 9]>
<script src="${pageContext.request.contextPath}/js/libs/html5shiv.js"></script>
<script src="${pageContext.request.contextPath}/js/libs/respond.min.js"></script>
<![endif]-->
</head>
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <ul class="menu boxed clearfix bg-image-home">
                        <li><a href="#"><i class="menu-icon menu-icon-1"></i>首 页</a></li>
                       
                        <li>
                            <a href="#"><i class="menu-icon menu-icon-4"></i>TV 秀</a>
                            <ul>
                                <li>
                                    <a href="#">Katy Perry</a>
                                    <ul>
                        ...
                        <li><a href="#"><i class="menu-icon menu-icon-5"></i>新 闻</a></li>
                        <li><a href="#"><i class="menu-icon menu-icon-6"></i>视 频</a></li>
                        <li><a href="#"><i class="menu-icon menu-icon-7"></i>画 廊</a></li>
                         <li>
                            <a href="#"><i class="menu-icon menu-icon-2"></i>在线音乐</a>
                            <ul>
                        ...
                        <li>
                            <a href="#"><i class="menu-icon menu-icon-3"></i>酷狗排行</a>
                            <ul>
                                <li><a href="#">Miley Cyrus</a></li>
                                <li><a href="#">Katy Perry</a></li>
                        ...
                        <li><a href="#"><i class="menu-icon menu-icon-8"></i>联系我们</a></li>
                    </ul>
                    <!--/ Website Menu -->
                </div>
            </div>
                    ...
                    <div class="post-tabs clearfix">
                        ...
                        <div class="post-tabs-content boxed">
                            ...
                            <div class="post-item style6 clearfix bg-image-arrow active">
                                <div class="post-image"><a href="${pageContext.request.contextPath}/images/temp/post-img-11.jpg" data-rel="prettyPhoto" title="Music"><img src="${pageContext.request.contextPath}/images/temp/post-img-11.jpg" alt="" /></a></div>
                            ...
                            <div class="post-item style6 clearfix bg-image-arrow">
                                <div class="post-image"><a href="${pageContext.request.contextPath}/images/temp/post-img-12.jpg" data-rel="prettyPhoto" title="Music"><img src="${pageContext.request.contextPath}/images/temp/post-img-12.jpg" alt="" /></a></div>
                                <div class="post-content">
                            ...
                            <!-- post item -->
                            <div class="post-item style6 clearfix bg-image-arrow">
                                <div class="post-image"><a href="${pageContext.request.contextPath}/images/temp/post-img-13.jpg" data-rel="prettyPhoto" title="Music"><img src="${pageContext.request.contextPath}/images/temp/post-img-13.jpg" alt="" /></a></div>
                                <div class="post-content">
                            ...
                            <!-- post item -->
                            <div class="post-item style6 clearfix bg-image-arrow">
                                <div class="post-image"><a href="${pageContext.request.contextPath}/images/temp/post-img-14.jpg" data-rel="prettyPhoto" title="Music"><img src="${pageContext.request.contextPath}/images/temp/post-img-14.jpg" alt="" /></a></div>
                                <div class="post-content">
                            ...
                            <ul id="schedule">
                                <li class="schedule-item clearfix">
                                    ...
                                    <div class="schedule-right">
                                        <div class="schedule-avatar"><a href="#"><img src="${pageContext.request.contextPath}/images/temp/schedule-avatar-1.jpg" alt="" /></a></div>
                                ...
                                <li class="schedule-item clearfix">
                                    ...
                                    <div class="schedule-right">
                                        <div class="schedule-avatar"><a href="#"><img src="${pageContext.request.contextPath}/images/temp/schedule-avatar-2.jpg" alt="" /></a></div>
                                        <div class="schedule-links">
                                            <a class="schedule-details" href="#"><i class="icon-small-info"></i>Details</a>
                                            <a class="schedule-add" href="#"><i class="icon-small-star"></i>Add to list</a>
                                        </div>
                                ...
                                <li class="schedule-item clearfix">
                                    ...
                                    <div class="schedule-right">
                                        <div class="schedule-avatar"><a href="#"><img src="${pageContext.request.contextPath}/images/temp/schedule-avatar-3.jpg" alt="" /></a></div>
                                        <div class="schedule-links">
                                            <a class="schedule-details" href="#"><i class="icon-small-info"></i>Details</a>
                                            <a class="schedule-add" href="#"><i class="icon-small-star"></i>Add to list</a>
                                        </div>
                                ...
                                <li class="schedule-item clearfix">
                                    ...
                                    <div class="schedule-right">
                                        <div class="schedule-avatar"><a href="#"><img src="${pageContext.request.contextPath}/images/temp/schedule-avatar-4.jpg" alt="" /></a></div>
                                        <div class="schedule-links">
                                            <a class="schedule-details" href="#"><i class="icon-small-info"></i>Details</a>
                                            <a class="schedule-add" href="#"><i class="icon-small-star"></i>Add to list</a>
                                        </div>
                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade" id="profile1">
                                ...
                                <div class="profile-image">
                                    <img src="${pageContext.request.contextPath}/images/temp/profile-1.jpg" alt="" />
                                </div>
                                <div class="bottom">
                            ...
                            <div class="tab-pane fade in active" id="profile2">
                                ...
                                <div class="profile-image">
                                    <img src="${pageContext.request.contextPath}/images/temp/profile-2.jpg" alt="" />
                                </div>
                                <div class="bottom">
                                    <div class="profile-desc">
                            ...
                            <div class="tab-pane fade" id="profile3">
                                ...
                                <div class="profile-image">
                                    <img src="${pageContext.request.contextPath}/images/temp/profile-3.jpg" alt="" />
                                </div>
                                <div class="bottom">
                                    <div class="profile-desc">
                            ...
                            <div class="tab-pane fade" id="profile4">
                                ...
                                <div class="profile-image">
                                    <img src="${pageContext.request.contextPath}/images/temp/profile-4.jpg" alt="" />
                                </div>
                                <div class="bottom">
                                    <div class="profile-desc">
            ...
            <div class="row">
                    ...
                    <div class="widget-container widget-top3chart boxed">
                        <ul class="chart-tab music">
                            <li class="clearfix">
                                ...
                                <div class="chart-avatar"><img src="${pageContext.request.contextPath}/images/temp/thumb-4.jpg" alt="" /></div>
                            ...
                            <li class="clearfix">
                                ...
                                <div class="chart-avatar"><img src="${pageContext.request.contextPath}/images/temp/thumb-6.jpg" alt="" /></div>
                            ...
                            <li class="clearfix">
                                ...
                                <div class="chart-avatar"><img src="${pageContext.request.contextPath}/images/temp/thumb-8.jpg" alt="" /></div>
                        ...
                        <ul class="chart-tab video active">
                            <li class="clearfix">
                                <span class="position">1</span>
                                <div class="chart-avatar"><img src="${pageContext.request.contextPath}/images/temp/thumb-9.jpg" alt="" /></div>
                                <a href="#" class="chart-title"><strong>She Wolf</strong>Shakira</a>
                                <a href="#" class="chart-like">593<i class="icon-small-like"></i></a>
                            </li>
                            <li class="clearfix">
                                <span class="position">2</span>
                                <div class="chart-avatar"><img src="${pageContext.request.contextPath}/images/temp/thumb-10.jpg" alt="" /></div>
                                <a href="#" class="chart-title"><strong>Wide Awake</strong>Katy Perry</a>
                                <a href="#" class="chart-like">412<i class="icon-small-like"></i></a>
                            </li>
                            <li class="clearfix">
                                <span class="position">3</span>
                                <div class="chart-avatar"><img src="${pageContext.request.contextPath}/images/temp/thumb-11.jpg" alt="" /></div>
                ...
                <div class="col-sm-7">
                    ...
                    <div class="widget-container widget-video boxed">
                        <video id="video1" controls preload="auto" poster="${pageContext.request.contextPath}/images/temp/vjs-poster-4.jpg" class="video-js vjs-styled-skin">
